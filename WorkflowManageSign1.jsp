...
function isSign(fg) {
	queryData({"url":"/workflow/request/signatureCount.jsp","requestId":"<%=requestid %>","nodeId":"<%=nodeid %>","userId":"<%=user.getUID() %>","loginType":"<%=user.getLogintype() %>","workflowid":"<%=workflowid%>"},function(paramsObj,msg){
