              ...
              while(billrs.next()){
               ...
               // System.out.println("select * from workflow_billfield where viewtype='1' and billid="+formid+" and detailtable='"+tablename+"'");
                ...
                while(rs.next()){
                    ...
                    isdeedits.add(Util.getIntValue(rs.getString("isedit"),0) + "");
                    isdemands.add(Util.getIntValue(rs.getString("ismandatory"),0) + "");
                }
                                        ...
                                        if(showtype == 2){
                                            ...
                                            if("".equals(preAdditionalValue)){
                                                if("y".equals(isdefault)){
                                                    checkemptydetail = false;
                                                    fieldhtml += " checked";
                                                    if(finalvaluedetail.equals("")){
                                                        finalvaluedetail = tmpselectvalue;
                                                    }else{
                                                        finalvaluedetail += "," + tmpselectvalue;
                                                    }
                                                }
                                            }else if(("," + preAdditionalValue + ",").indexOf("," + tmpselectvalue + ",") >= 0){
                                                checkemptydetail = false;
                                                fieldhtml += " checked";
                                                if(finalvaluedetail.equals("")){
                                                    finalvaluedetail = tmpselectvalue;
                                            ...
                                            fieldhtml += " onclick=";
                                            fieldhtml += "selectItemCheckChange(this,'" + defieldid + "_\"+rowindex+\"');";
                                            fieldhtml += "checkinput3(field" + defieldid + "_\"+rowindex+\",field" + defieldid + "_\"+rowindex+\"span,this.viewtype);";
                                            ...
                                            fieldhtml += " name='field" + defieldid + "_\"+rowindex+\"_" + tmpselectvalue + "_disp' id='field" + defieldid + "_\"+rowindex+\"_" + tmpselectvalue + "' ";
                                            ...
                                            fieldhtml += " viewtype='"+isdemand+"'";
                                            if("".equals(preAdditionalValue)){
                                                if("y".equals(isdefault) && finalvaluedetail.equals("")){
                                                    checkemptydetail = false;
                                                    fieldhtml += " checked";
                                                    finalvaluedetail = tmpselectvalue;
                                                }
                                            }else if(preAdditionalValue.equals(tmpselectvalue)){
                                                checkemptydetail = false;
                                                fieldhtml += " checked";
                                                finalvaluedetail = tmpselectvalue;
                                            }
                	...
                	//                System.out.println("tmpselectvalue="+tmpselectvalue);
                            ...
                            if (isdeedit.equals("0") || showtype == 2 || showtype == 3){
                                ...
                                if(showtype == 2 || showtype == 3){
                                    ...
                                    fieldhtml += " viewtype='"+isdemand+"' ";
                                    fieldhtml += " temptitle='"+defieldlable+"' ";
                                    fieldhtml += "value='" + finalvaluedetail + "'";
                                }else{
                                    fieldhtml += "value='" + selectElementValue + "'";
                                }
                                if(showtype != 2 && showtype != 3){
	                            if(seldefieldsadd.indexOf(defieldid)>=0){
                                    ...
                                    //单选按钮时，需要将onchange事件放到onpropertychange中
                                }else if(showtype == 3){
                                    if(seldefieldsadd.indexOf(defieldid)>=0){
                                        fieldhtml += " onpropertychange=changeshowattr('"+defieldid+"_1',this.value,\"+rowindex+\","+workflowid+","+nodeid+");"+trrigerdetailStr+onchangeAddStr+" ";
                                    }else{
	                            ...
	                            while (rs.next()) {
	                                ...
	                                if("".equals(preAdditionalValue)){
                                        ...
                                        if(showtype == 2){
                                            ...
                                            fieldhtml += "selectItemCheckChange(this,'" + defieldid + "_\"+rowindex+\"');";
                                            fieldhtml += "checkinput3(field" + defieldid + "_\"+rowindex+\",field" + defieldid + "_\"+rowindex+\"span,this.viewtype);";
                                            fieldhtml += "changeshowattr('"+defieldid+"_1',this.value,\"+rowindex+\","+workflowid+","+nodeid+");"+trrigerdetailStr+" ";
                                            //if(seldefieldsadd.indexOf(defieldid)>=0){
                                            //    fieldhtml += "changeshowattr('"+defieldid+"_1',this.value,\"+rowindex+\","+workflowid+","+nodeid+");";
                                            //}
                                            //fieldhtml += trrigerdetailStr+onchangeAddStr+" ";
