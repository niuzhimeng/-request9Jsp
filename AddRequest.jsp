...
if(!haveVerifyForward){
	...
	if(createSPA){
		String url = "/spa/workflow/index_form.jsp#/main/workflow/req?iscreate=1&";
...
if((IsFreeWorkflow && !"1".equals(isFree)) || ("1".equals(isFree) && "2".equals(freewftype) && IsFreeWorkflow)){
    ...
    RCMenuHeight += RCMenuHeightStep ;
    if(WFForwardManager.judgeIsFreeWorkflow(Util.getIntValue(workflowid))  && "2".equals(freewftype))
