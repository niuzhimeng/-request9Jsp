	  ...
	  <wea:group context='<%=SystemEnv.getHtmlLabelName(26437,user.getLanguage())%>'>
	     <wea:item attributes="{'isTableList':'true'}">
	        <table class="ListStyle" id="oTable" cellspacing=0>
				...
				%>
							<td>
								<input type="radio" name="rejectnodeid" onclick="checkIfSingle(this,0)" onchange="checkIfSingle(this,0)" value="<%=rejectnodeids.get(i)%>" <%if(defaultnodeid==Util.getIntValue((String)rejectnodeids.get(i))){%>checked<%}%>>
							</td>
