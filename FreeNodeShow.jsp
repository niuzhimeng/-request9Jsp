...
<!--	<script type="text/javascript" src="/js/jquery/jquery_wev8.js"></script>-->
	...
	<%
		...
		int secLevel = Util.getIntValue(request.getParameter("secLevel"), -999);
		//当前节点
		int nodeid = -1;
		//当前节点流转的下一个节点
		...
		if(requestid == -1){
			...
			if(nodeid == -1){
				nodeid = Util.getIntValue(request.getParameter("nodeid"));
			}
		}	
	...
	<script type="text/javascript">
		...
		function setFormEdit(val){
			if(val == "1"){
				jQuery("#spanOther_disable").find("span[name='frmsspan']").html("<%=SystemEnv.getHtmlLabelName(360,user.getLanguage())%>");
			}else{
				jQuery("#spanOther_disable").find("span[name='frmsspan']").html("<%=SystemEnv.getHtmlLabelName(309,user.getLanguage())%>");
			}
		}
	</script>
  </head>
  ...
  <body>
  	<div>
		...
		<div id="detail_disable" style="display: none;">
			<table width='100%' cellpadding="0" cellspacing="0" border="0"><tr><td align="center">
			<div style='margin: 0;'>
				<div class='spanBase'><%=SystemEnv.getHtmlLabelName(16261, user.getLanguage())%></div>
			</div>
			</td></tr><tr><td>
			<div style="margin-left: 10px;margin:0px 6px 0px 6px; ">
				<div id='spanBase_disable'>
					<table width='100%'>
						<tr style="height:30px;">
							<td width="70px"><%=SystemEnv.getHtmlLabelName(195, user.getLanguage())%></td>					
							<td>
								<span class=inputstyle style="width:150px" name='nodenamespan'></span>
							</td>		
						</tr>
						<TR style="height:1px;">
						...
						<tr style="height:30px;">
							<td width="70px"><%=SystemEnv.getHtmlLabelName(15536, user.getLanguage())%></td>					
							<td>
								<span style="width:150px" name='nodetypespan'></span>
							</td>
						</tr>
						<TR style="height:1px;">
							<TD class=Line colSpan=2></TD>
						...
						<tr style="height:30px;">
							<td width="70px"><%=SystemEnv.getHtmlLabelName(21790, user.getLanguage())%></td>					
							<td>
								<span style="width:150px" name='Signtypespan'></span>
							</td>
						</tr>
						<TR style="height:1px;">
							<TD class=Line colSpan=2></TD>
						...
						<tr style="height:30px;">
							<td width="70px"><%=SystemEnv.getHtmlLabelName(553, user.getLanguage())%><%=SystemEnv.getHtmlLabelName(127, user.getLanguage())%></td>				
							<td>
								<span style="width:150px" name='operatornamesspan'></span>
							</td>
						</tr>
					</table>
				</div>
				<div id='spanOther_disable' style='display:block'>
					<table width='100%'>
						<TR style="height:1px;">
							<TD class=Line colSpan=2></TD>
						</TR>
						<tr height='30px'>
							<td width="70px"><%=SystemEnv.getHtmlLabelName(124788, user.getLanguage())%></td>					
							<td>
								<span style="width:150px" name='roadspan'></span>
							</td>		
						</tr>
						<TR style="height:1px;">
							<TD class=Line colSpan=2></TD>
						...
						<tr height='30px'>
							<td width="70px"><%=SystemEnv.getHtmlLabelName(33473, user.getLanguage())%></td>					
							<td>
							<span style="width:150px" name='frmsspan'></span>
							</td>	
						</tr>
						<TR style="height:1px;">
							<TD class=Line colSpan=2></TD>
		...
		<div id="detail" style="display: none;">
			...
			<div style="margin-left: 10px;margin:0px 6px 0px 6px; ">
				<div id='spanBase'>
					<table width='100%'>
						...
						<tr style="height:30px;">
							...
							<td>
								<%
								   if(secLevel != -999)	{//人力资源浏览按钮增加密级过滤
								%>
								<brow:browser _callback="browserCallback" viewType="0" name="operators" browserValue="" browserUrl='<%="/systeminfo/BrowserMain.jsp?url=/hrm/resource/MutiResourceBrowser.jsp?selectedids=&sqlwhere="+xssUtil.put(" classification <= " + secLevel + "" )%>' hasInput="true" isSingle="false" hasBrowser = "true" isMustInput='2' completeUrl='<%="/data.jsp?sqlwhere=" +xssUtil.put(" classification <= " + secLevel + "" )%>' width="118px" browserSpanValue=""> </brow:browser>
				...
				<div id='spanOther' style='display:block'>
					<table width='100%'>
						<%-- 
						<TR style="height:1px;">
							<TD class=Line colSpan=2></TD>
						...
						<tr height='30px' style="display:none;">
							<td width="70px"><%=SystemEnv.getHtmlLabelName(15586, user.getLanguage())%><%=SystemEnv.getHtmlLabelName(21650, user.getLanguage())%></td>		
