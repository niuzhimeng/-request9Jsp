...
<%
	...
	if(!isOracle) {
	    if(RecordSet.getDBType().equalsIgnoreCase("mysql")){
	        s.append("fieldOldText fieldOldText,");
            s.append("fieldNewText fieldNewText,");
	    }else{
	...
	if(!isOracle) {
	    if(RecordSet.getDBType().equalsIgnoreCase("mysql")){
	        s.append("t1.fieldOldText fieldOldText,");
	        s.append("t1.fieldNewText fieldNewText,");
	    }else{
