...
String sql="select id from Workflow_DataInput_entry where WorkFlowID="+wflid+" and TriggerFieldName='"+triggerfieldname+"' and (enable is null or enable<>1)";
       ...
       if(DDI.GetIsCycle().equals("1")){   //主表字段更新
       	for(int i=0;i<outdatasList.size();i++){
       		...
       		for(int j=0;j<outfieldnamelist.size();j++){
				...
				System.out.println(tempfield +"  ==   "+tempValue);
       		    ...
       		    //tempValue = Util.StringReplace(tempValue,"\"","\\\\\\\"");
					...
					if(tempfield.equals("field52807")){
