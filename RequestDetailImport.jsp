...
String isfromE9 = Util.null2String(request.getParameter("isfromE9"),"0");
...
int userid = user.getUID();
	...
	if(nodeid == -1){
		nodeid = Util.getIntValue(request.getParameter("nodeid"),-1);
	}
...
<input type=hidden name="isfromE9" value="<%=isfromE9%>">
