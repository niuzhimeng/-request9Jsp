...
if(true) {
	response.sendRedirect("/workflow/workflowDesign/readOnly.html?isFromAutodirect=1&isFromWfForm=true&requestId="+requestid+"&workflowId="+workflowid+"&f_weaver_belongto_userid="+f_weaver_belongto_userid+"&f_weaver_belongto_usertype="+f_weaver_belongto_usertype);
	return;
}
