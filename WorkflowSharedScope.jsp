	...
	<BODY style="overflow: hidden;">
		...
		<wea:item attributes="{'isTableList':'true'}">
			<%
					...
					String otherParaobj = "column:departmentid+column:subcompanyid+column:userid+column:roleid+column:rolelevel+"+user.getLanguage()+"+column:jobid+column:joblevel+column:jobobjid";
