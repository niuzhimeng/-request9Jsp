...
if(intervenorright>0){
    ...
    if(nodeattr.equals("2")){
        //BrancheNodes=WFLinkInfo.getFlowBrancheNodes(requestid,workflowid);
     	...
     	//System.out.println(BrancheNodes);
    }
    ...
    while(RecordSet.next()){
    	VisitedNodes.add(RecordSet.getString(1));
    }
//查询节点操作者
		...
		<wea:item>
			<select class=inputstyle  id="submitNodeId" name=submitNodeId  onChange='nodechange(this.value)'  temptitle="<%=SystemEnv.getHtmlLabelName(18914,languageidfromrequest)%>" notBeauty="true">
                 ...
                 while(WFNodeMainManager.next()){
                    ...
                    //System.out.println("tmpname = "+tmpname+"  tempnodeattr = "+tempnodeattr);
                    if(tmpid==nodeid) {
                    ...
                    if(nodeattr.equals("2")){
                        if(!tempnodeattr.equals("2")){
                        	...
                        	//System.out.println("tmpname="+tmpid+"/"+tmpname+" tmptype="+tmptype+" tempnodeattr="+tempnodeattr);
                            continue;
                        }
                    }else{
                        if(tempnodeattr.equals("2")){
