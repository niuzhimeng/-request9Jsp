...
if(RecordSet.getDBType().equals("oracle")){
	...
	sqlstr = "select distinct workflow_requestbase.requestid ,requestname,creater,createdate,createtime into "+temptable+" from workflow_requestbase , workflow_currentoperator " + sqlwhere + " and workflow_currentoperator.requestid = workflow_requestbase.requestid and userid=" +userid + " and usertype="+usertype+" order by createdate desc , createtime desc limit "+(pagenum*perpage+1)+" " ;
}else{
...
if(RecordSet.getDBType().equals("oracle")){
	...
	sqltemp="select * from "+temptable+"  order by createdate , createtime limit "+(RecordSetCounts-(pagenum-1)*perpage);
}else{
