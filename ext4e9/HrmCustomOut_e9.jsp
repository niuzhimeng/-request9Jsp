...
<%@ page import="com.engine.kq.biz.KQExitRulesBiz,com.engine.kq.enums.KqSplitFlowTypeEnum,com.engine.kq.wfset.attendance.domain.WorkflowBase,com.engine.kq.wfset.attendance.manager.WorkflowBaseManager" %>
...
<%
    ...
    Map<String,Object> result = attProcSetManager.getFieldList(2,workflowid, formid);
    ...
    String isAttOk = "1";
    String msgAttError = "";
    Map<String,String> check = KQAttFlowCheckUtil.checkAttFlow(result, KqSplitFlowTypeEnum.OUT);
...
<script >
  ...
  function getWorkDuration(id,value,rowIndex){
    ...
    jQuery.ajax({
      url : "/api/hrm/kq/attendanceEvent/getOutWorkDuration",
      type : "post",
      processData : false,
      data : _data,
      dataType : "json",
