...
<%@ include file="/workflow/request/RequestShowHelpDoc.jsp" %>
        ...
        <input type=hidden name=ehnextnodeid value="<%=ehnextnodeid %>"/>
...
diag_vote.show();
	...
	function setbodyiframe(){
		...
		//System.out.println("-------1-------docfileid_xx="+docfileid_xx+",newdocid_xx="+newdocid_xx+",uselessFlag="+uselessFlag);
