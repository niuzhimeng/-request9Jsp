                        ...
                        <%
							 ...
							 //add by liaodong for qc75759 in 2013年10月23日 start
								...
								int decimaldigits_t = 2;
										if(defieldtype.equals("3") && defieldhtmltype.equals("1")){
                        ...
                        <%                                      
                                   ...
                                   <%
                                        ...
                                        if("0".equals(isbill)){
                                            ...
                                            RecordSet.executeQuery("select type,fieldshowtypes from workflow_billfield where id=?",defieldid);
                                        }
                                        if(RecordSet.next()){
                                           ...
                                           <%
                                                ...
                                                <% if(showtype == 2){%>
                                                    <input type='checkbox' DISABLED
                                                      ...
                                                      <% if(("," + defieldvalue + ",").indexOf("," + tmpselectvalue + ",") >=0){ %> checked <%} %> 
                                                      >
                                                <%} else{%>
                                                    <input type='radio' DISABLED
                                                      value=<%=tmpselectvalue %> 
                                                      <% if(defieldvalue.equals(tmpselectvalue)){ %> checked <%} %>
                                                    >
                                                <%} %>
