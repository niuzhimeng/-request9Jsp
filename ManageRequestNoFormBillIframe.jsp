...
window.onbeforeunload = function protectManageBillFlow(event){
    ...
    { 
       jQuery($GetEle("flowbody")).attr("onbeforeunload", "");
       $GetEle("fileDownload").src="/weaver/weaver.file.FileDownload?f_weaver_belongto_userid=<%=userid%>&f_weaver_belongto_usertype=<%=usertype%>&fieldvalue="+fieldvalue+"&download=1&downloadBatch=1&desrequestid=<%=desrequestid%>&requestid="+requestid;
    }
