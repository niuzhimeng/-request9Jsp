        ...
        %>
          ...
          <TABLE cols=3 id="field<%=fieldid%>_tab">
           ...
           %>
            <tr> 
              <td colSpan=3><nobr>
                  <button style="color:#123885;border:0px;line-height:20px;font-size:12px;padding:3px;background: #fff" class=wffbtn type=button accessKey=1  onclick="top.location='/weaver/weaver.file.FileDownload?fieldvalue=<%=fieldvalue%>&download=1&downloadBatch=1&requestid=<%=requestid%>'">
