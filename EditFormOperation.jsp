...
boolean isoracle = rs.getDBType().equals("oracle")&&!Util.null2String(rs.getOrgindbtype()).equals("dm")&&!Util.null2String(rs.getOrgindbtype()).equals("st");
...
while (rs.next()) {
    ...
    if (fieldhtmltype.equals("3") && (fieldtype.equals("1") || fieldtype.equals("17"))) { // 人力资源字段
		...
		if (fieldtype.equals("17")) {
		    try {
		        WFPathBrowserUtil.updateBrowInfo(fu.getRequest(), requestid, fieldid);
		    } catch (Exception e9) {
		        e9.printStackTrace();
		    }
		}
